...
describe('FeaturesSection', () => {
    test('рендерить компонент з усіма функціями', () => {
        ...
        expect(screen.getByText(/Функція перевірки сумісності допоможе вам легко зібрати ваш ідеальний комп'ютер/i)).toBeInTheDocument();
        expect(screen.getByText(/Наша функція надає корисні поради щодо догляду за кожним компонентом/i)).toBeInTheDocument();
    });
});
